...
<head>
    ...
    <title>Solicitar Firmas Electrónicas</title>
...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Solicitar Firmas Electrónicas</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <div class="container-fluid">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active" href="">ENVÍA TUS DOCUMENTOS POR CORREO ELECTRÓNICO PARA QUE SEAN FIRMADOS</a>
                </li>
            </ul>
        </div>
    </nav>
                    ...
                    <thead>
                                        ...
                                        <?php foreach ($data["documentos"] as $dato) { ?>
                                                ...
                                                <div class="col-lg-10  d-inline-flex">
                                                        ...
                                                        <form method="post" action="../view/documentos/crearSolicitud.php" value="<?php $dato["ruta"] ?>">
                                                        <input type="hidden" name="ruta" id="ruta" value="<?php echo  $dato["ruta"] ?>" >
                                                        <input type="hidden" name="id" id="idDOC" value="<?php echo  $dato["id"] ?> ">
                
                                                        <button class="btn btn-outline-success botonCrearSolicitud" ">
                                                        <span class="">Solicitar e-firma</span>
                                                        </button>
                                                        </form>
